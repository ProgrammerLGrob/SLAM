...
class OdomImuCsvWriter(Node):
    """
    ROS 2 Node responsible for subscribing to localization data topics and 
    ...
    def odom_callback(self, msg):
        """
        Processes standard wheel odometry data updates, calculates float timestamps, 
    ...
    def imu_callback(self, msg):
        """
        Receives structural IMU orientation frames, extracts yaw orientation data, 
    ...
    def visual_odom_callback(self, msg):
        """
        Processes updates published by the visual odometry algorithm pipeline, 
